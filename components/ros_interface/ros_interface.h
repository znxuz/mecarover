...
namespace imsl {
/**
 * @brief connect to ros agent, initialize publisher, subscriber and executor, start ros_spin funktion  ...
 * @param ct pointer to the robot controller tasks 
 */
void rosInit(void * ct);
/**
 * @brief polls the ROS connection state
...
//void setSensors(UltrasonicSensor * fs, UltrasonicSensor * bs, UltrasonicSensor * rs, UltrasonicSensor * ls);
